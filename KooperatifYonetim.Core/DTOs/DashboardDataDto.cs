namespace KooperatifYonetim.Core.DTOs
{
    public class DashboardDataDto
    {
        ...
        public List<YaklasanIslemItemDto> YaklasanIslemler { get; set; } = [];
        ...
        public List<SutGunlukDto> HaftalikSutGrafik { get; set; } = [];
    ...
    public class YaklasanIslemItemDto
    {
